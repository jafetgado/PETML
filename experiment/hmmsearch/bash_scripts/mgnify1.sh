...
#SBATCH --ntasks=1
#SBATCH --time=4:00:00
#SBATCH --output=./experiment/hmmsearch/stdout/mgnify1.out
#SBATCH --error=./experiment/hmmsearch/stdout/mgnify1.err
...
#-o ./experiment/hmmsearch/data/output/mgnify1_output.txt \
#--tblout ./experiment/hmmsearch/data/output/mgnify1_tabout.txt \
#-A ./experiment/hmmsearch/data/output/mgnify1_aln.sto --noali \
...
aln_file = './experiment/hmmsearch/data/output/mgnify1_aln.sto';
fasta_file = './experiment/hmmsearch/data/output/mgnify1_aln.fasta';
