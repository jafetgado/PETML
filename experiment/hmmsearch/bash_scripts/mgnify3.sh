...
#SBATCH --ntasks=1
#SBATCH --time=4:00:00
#SBATCH --output=./experiment/hmmsearch/stdout/mgnify3.out
#SBATCH --error=./experiment/hmmsearch/stdout/mgnify3.err
...
-o ./experiment/hmmsearch/data/output/mgnify3_output.txt \
--tblout ./experiment/hmmsearch/data/output/mgnify3_tabout.txt \
-A ./experiment/hmmsearch/data/output/mgnify3_aln.sto --noali \
...
aln_file = './experiment/hmmsearch/data/output/mgnify3_aln.sto';
fasta_file = './experiment/hmmsearch/data/output/mgnify3_aln.fasta';
