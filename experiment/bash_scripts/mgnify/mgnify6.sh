...
#SBATCH --output=./experiment/stdout/mgnify/mgnify6.out
#SBATCH --error=./experiment/stdout/mgnify/mgnify6.err
...
-o ./experiment/data/hmmsearch/output/mgnify/mgnify6_output.txt \
--tblout ./experiment/data/hmmsearch/output/mgnify/mgnify6_tabout.txt \
-A ./experiment/data/hmmsearch/output/mgnify/mgnify6_aln.sto --noali \
...
aln_file = './experiment/data/hmmsearch/output/mgnify/mgnify6_aln.sto';
fasta_file = './experiment/data/hmmsearch/output/mgnify/mgnify6_aln.fasta';
