...
#SBATCH --output=./experiment/stdout/ncbi.out
#SBATCH --error=./experiment/stdout/ncbi.err
...
-o ./experiment/data/hmmsearch/output/ncbi_output.txt \
--tblout ./experiment/data/hmmsearch/output/ncbi_tabout.txt \
-A ./experiment/data/hmmsearch/output/ncbi_aln.sto --noali \
...
aln_file = './experiment/data/hmmsearch/output/ncbi_aln.sto';
fasta_file = './experiment/data/hmmsearch/output/ncbi_aln.fasta';
