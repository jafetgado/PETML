...
#SBATCH --output=./experiment/stdout/jgi.out
#SBATCH --error=./experiment/stdout/jgi.err
...
-o ./experiment/data/hmmsearch/output/jgi_output.txt \
--tblout ./experiment/data/hmmsearch/output/jgi_tabout.txt \
-A ./experiment/data/hmmsearch/output/jgi_aln.sto --noali \
...
aln_file = './experiment/data/hmmsearch/output/jgi_aln.sto';
fasta_file = './experiment/data/hmmsearch/output/jgi_aln.fasta';
